...
data_update.to_csv("hilus-calcium_cleaned.csv")
...
print(mdf1.summary(alpha=0.001)) #still significant
print(mdf2.summary(alpha=0.001)) #still significant