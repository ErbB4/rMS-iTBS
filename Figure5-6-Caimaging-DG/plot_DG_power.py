...
fig = plt.figure(1,figsize=(cm2inch(4.5), cm2inch(3.7)))
...
stats_AUC(sham_3h_traces,rMS_3h_traces,sham_24h_traces,rMS_24h_traces)
...
plt.figure(1)
plt.savefig("DG_heatmap.svg")
plt.figure(2)
plt.savefig("DG_averaged_trace_power.svg")
plt.show()
