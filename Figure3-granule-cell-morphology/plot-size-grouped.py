...
def get_2_hists(data,t1,t2):
    ...
    new_data_control = plot_diffs_histogram_by_size(data,ax1,"control",t1,t2)
    new_data_rms = plot_diffs_histogram_by_size(data,ax1,"rMS",t1,t2)
    ...
    new_data_control.to_csv("control_delta_size_"+str(t1)+"_"+str(t2)+".csv")
    new_data_rms.to_csv("rms_delta_size_"+str(t1)+"_"+str(t2)+".csv")
