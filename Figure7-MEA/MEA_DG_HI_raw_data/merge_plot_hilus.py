...
def get_AUC_all_data(data_raw):
    ...
    a1,a2 = get_AUC_and_compare(h0_ctr,h0_rms,"hilus-h0")
    a3,a4 = get_AUC_and_compare(h3_ctr,h3_rms,"hilus-h3")
    a5,a6 = get_AUC_and_compare(h24_ctr,h24_rms,"hilus-h24")
...
data_raw = pd.read_csv("Hilus-MEA.csv")
h0_ctr,h0_rms,h3_ctr,h3_rms,h24_ctr,h24_rms = clean_data(data_raw)
...
plt.figure(1)
plt.savefig("MEA_average_FR_hilus.svg")
